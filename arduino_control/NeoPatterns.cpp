//https://learn.adafruit.com/multi-tasking-the-arduino-part-3/take-it-for-a-spin
#include <Adafruit_NeoPixel.h>

// Pattern types supported:
static const char *PATTERN_STRING[] = {"NONE", "RAINBOW_CYCLE", "THEATER_CHASE", "COLOR_WIPE", "SCANNER", "FADE", "PULSE"};
...
class NeoPatterns : public Adafruit_NeoPixel {
    ...
    void Pulse(uint32_t color, uint8_t interval, uint16_t totalSteps, direction dir = FORWARD) {
      Color1 = color;
      Interval = interval;
    ...
    void PulseUpdate() {
      uint16_t halfSteps = TotalSteps >> 1;  
...
void Ring2Complete()
{
    if (digitalRead(9) == LOW)  //   #2 pressed
    {
